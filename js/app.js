(() => {
    ...
    function initSliders() {
        if (document.querySelector(".teamswiper")) new core(".teamswiper", {
        ...
        if (document.querySelector(".newcollectionswiper")) new core(".newcollectionswiper", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    if (document.querySelector(".revenues__sliders")) {
        const thumbsSwiper = new core(".sliderpicture", {
            modules: [ Thumb, Autoplay, EffectFade ],
            observer: true,
            watchOverflow: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        new core(".sliderinfo", {
            modules: [ Thumb, Pagination, Autoplay, EffectFade ],
            observer: true,
            watchOverflow: true,
            observeParents: true,
            thumbs: {
